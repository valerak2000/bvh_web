        ...
        return (
            ...
            >
                ...
                <CardText
                    ...
                    className = 'content'
                >
                    <p><strong>ООО «Брюховецкое водопроводное хозяйство» занимается водоснабжением и водоотведением
                    ст.Брюховецкой, ст.Переяславской, х.Сопова Балка, с.Свободное.
                    В настоящее время источником хозяйственно-питьевого и производственного
                    водоснабжения поселения являются подземные воды.
                    В настоящее время население снабжается водой от 10 артскважин дебетом 3384 м3/ч.
