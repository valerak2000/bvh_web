                ...
                <ListItemAvatar>
                    <Avatar
                        className={classnames(
                            'avatar',
                            unReadItems.length > 0 ? 'avatarNew' : open ? 'avatarHighlight' : ''
                        )}
                    >
                        {unReadItems.length > 0 ? unReadItems.length : items.length}
                    </Avatar>
                </ListItemAvatar>
                <ListItemText primaryTypographyProps={{ className: 'title' }} primary={title} />
                {open && (
...
NotificationGroup.propTypes = {
    ...
    open: PropTypes.bool,
    badgeColor: PropTypes.oneOf(['inherit', 'primary', 'secondary', 'default', 'error'])
};
