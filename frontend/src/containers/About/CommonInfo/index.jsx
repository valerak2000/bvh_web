    ...
    render() {
        ...
        return (
            ...
            >
                ...
                >
                    <p style = { textIdent }>
                        <strong>ООО «Брюховецкое водопроводное хозяйство» (ООО «БВХ»)</strong> зарегистрировано 23 декабря 2005г.
                    </p>
                    <p style = { textIdent }>
                    ...
                    <br />
                    <p style = { textIdent }>
                        <strong>ООО «Брюховецкое предприятие отвода и очистки стоков» (ООО «БООС»)</strong> занимается водоотведением ст.Брюховецкой.<br/>
