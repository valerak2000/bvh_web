...
function FizlicaPaymentsView(props) {
    ...
    return (
        <Card square={true} sx={card}>
            <CardHeader title="Способы оплаты" {...props} />
            <CardContent sx={card.text}>
                ...
                >
                    ...
                    <span style={subParagraf}>
                        Произвести оплату за услуги холодного водоснабжения и водоотведения без
                        комиссии можно в кассе ООО «БВХ» по
                    </span>
                    <br />
                    <span style={subParagraf}>адресу: ул. Советская, 56, здание БТИ.</span>
                    <br />
                    <strong>Банки</strong>
                    <br />
                    <span style={subParagraf}>
                        В банковских учреждениях ООО КБ «КубаньКредит», ОАО «Сбербанк России», ОАО
                        «Крайинвестбанк».
                    </span>
                    <br />
                    <span style={subParagraf}>
                        Информацию по дополнительным офисам обслуживания Вы можете получить на
                        сайтах перечисленных организаций.
                    </span>
                    <br />
                    ...
                    <br />
                    <strong>Банкомат и интернет-банк</strong>
                    <br />
                    <span style={subParagraf}>
                        Оплата осуществляется банковской картой через сайт или банкомат выбранного
                        банка. Для этого необходимо в меню
                    </span>
                    <br />
                    <span style={subParagraf}>
                        выбрать опцию «Оплата ЖКУ» - «Брюховецкое водопроводное хозяйство» - «Номер
                        лицевого счета» - «Показания ПУ».
                    </span>
                    <br />
                    <span style={subParagraf}>
                    ...
                    <br />
                    <strong>Автоплатеж Сбербанк</strong>
                    <br />
                    <span style={subParagraf}>
                        <Button
                            focusRipple={false}
                    ...
                    <br />
                    <span style={subParagraf}>
                        Для подключения услуги Автоплатеж перейдите по этой{' '}
                        <a
                            href="http://www.sberbank.ru/ru/person/paymentsandremittances/payments/zhkh"
                            target="_blank"
                        >
                            ссылке
                        </a>
