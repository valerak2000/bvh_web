...
function FizlicaZaklyuchenieDogovorovHolvodView(props) {
...
FizlicaZaklyuchenieDogovorovHolvodView.propTypes = {
    theme: PropTypes.object.isRequired,
};

export default FizlicaZaklyuchenieDogovorovHolvodView;
