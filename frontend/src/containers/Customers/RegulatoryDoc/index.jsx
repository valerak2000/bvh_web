...
const federalnyy_zakon_o_vodosnabzhenii_i_vodootvedenii =
    '/static/files/media/potrebiteliam/federalnyy_zakon_o_vodosnabzhenii_i_vodootvedenii.pdf';
...
const sp_vnutrenniy_vodoprovod_i_kanalizaciya_zdaniy =
    '/static/files/media/potrebiteliam/sp_vnutrenniy_vodoprovod_i_kanalizaciya_zdaniy.pdf';

function RegulatoryDocView(props) {
    const theme = useTheme();
    const { card } = theme.app;

    return (
        <Card square={true} sx={card}>
            <CardHeader title="Нормативные документы" {...props} />
...
RegulatoryDocView.propTypes = {
    theme: PropTypes.object.isRequired
};

export default RegulatoryDocView;
